        ...
        <GuestLayout>
            ...
            <form onSubmit={submit}>
                <div>
                    ...
                    <p className="mt-1 text-[10px] text-gray-500">You must be at least 16 years old to use SquadSpawn.</p>
                </div>

                <div className="mt-4 rounded-lg border border-ink-900/5 bg-bone-50/50 p-3">
                    <p className="text-[11px] leading-relaxed text-gray-500">
                        <strong className="text-ink-500">Safety Notice:</strong> SquadSpawn is committed to online safety. We do not share your date of birth with other users.
                    </p>
                </div>
