                ...
                <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
                    ...
                    {likedByCount > 0 && (
                        ...
                        >
                            ...
                            <p className="flex-1 text-sm text-gray-300"><strong className="text-gaming-pink">{likedByCount}</strong> {likedByCount === 1 ? 'gamer wants' : 'gamers want'} to play with you!</p>
