            ...
            <div className="min-h-screen bg-bone-50 text-ink-900">
                ...
                <div className="mx-auto max-w-3xl px-6 py-12">
                    ...
                    <div className="space-y-6 text-sm leading-relaxed text-ink-700">
                        ...
                        {/* 1. What Are Cookies */}
                        <h2 className="text-xl font-semibold text-ink-900">1. What Are Cookies</h2>
                        <p>
                        ...
                        {/* 2. Essential Cookies */}
                        <h2 className="text-xl font-semibold text-ink-900">2. Cookies We Use</h2>

                        <h3 className="text-lg font-medium text-ink-900">2.1 Essential Cookies (Strictly Necessary)</h3>
                        <p>
                        ...
                        <h3 className="text-lg font-medium text-ink-900">2.2 Functional Cookies</h3>
                        <p>
                        ...
                        <h3 className="text-lg font-medium text-ink-900">2.4 Third-Party Cookies</h3>
                        <p>
                            ...
                            <table className="w-full text-left text-ink-500">
                                <thead>
                                    <tr className="border-b border-gray-700">
                                        ...
                                        <th className="py-2 pr-4 text-ink-700">Purpose</th>
                                        <th className="py-2 text-ink-700">Policy</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-800">
                                    <tr>
                        ...
                        <h2 className="text-xl font-semibold text-ink-900">3. How to Manage Cookies</h2>
                        <p>
                            You have several options for managing cookies:
                        </p>

                        <h3 className="text-lg font-medium text-ink-900">3.1 Cookie Consent Banner</h3>
                        <p>
                        ...
                        <h3 className="text-lg font-medium text-ink-900">3.2 Browser Settings</h3>
                        <p>
                        ...
                        <ul className="ml-4 list-disc space-y-1 text-ink-500">
                            <li>
                                <a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-neon-red hover:underline">
                                    Google Chrome
                                </a>
                            </li>
                            <li>
                                <a href="https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox-desktop" target="_blank" rel="noopener noreferrer" className="text-neon-red hover:underline">
                                    Mozilla Firefox
                                </a>
                            </li>
                            <li>
                                <a href="https://support.apple.com/guide/safari/manage-cookies-sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-neon-red hover:underline">
                                    Apple Safari
                                </a>
                            </li>
                            <li>
                        ...
                        <h2 className="text-xl font-semibold text-ink-900">4. Changes to This Cookie Policy</h2>
                        <p>
                        ...
                        <h2 className="text-xl font-semibold text-ink-900">5. Contact Information</h2>
                        <p>
