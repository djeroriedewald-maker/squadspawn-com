                ...
                <div className="mx-auto max-w-3xl px-6 py-12">
                    ...
                    <div className="space-y-6 text-sm leading-relaxed text-gray-300">
                        ...
                        <ul className="ml-4 list-disc space-y-1 text-gray-400">
                            ...
                            <li>Notify us immediately at <a href="mailto:info@squadspawn.com" className="text-gaming-purple hover:underline">info@squadspawn.com</a> if you suspect unauthorized access to your account.</li>
                        ...
                        <ul className="ml-4 list-disc space-y-1 text-gray-400">
                            <li><strong className="text-gray-300">Harassment and bullying:</strong> Engage in harassment, bullying, intimidation, stalking, or threatening behavior toward any user.</li>
                            <li><strong className="text-gray-300">Hate speech:</strong> Post or transmit content that promotes hatred, discrimination, or violence based on race, ethnicity, national origin, religion, gender, gender identity, sexual orientation, disability, or any other protected characteristic.</li>
                            <li><strong className="text-gray-300">Sexual or explicit content:</strong> Upload, share, or display sexually explicit, pornographic, or obscene content in your avatar, profile, messages, or any other area of the platform.</li>
                            <li><strong className="text-gray-300">Spam:</strong> Send unsolicited messages, advertisements, or promotional material to other users.</li>
                            <li><strong className="text-gray-300">Impersonation:</strong> Impersonate another person, create fake profiles, or misrepresent your identity or affiliation.</li>
                            <li><strong className="text-gray-300">Cheating and hacking:</strong> Attempt to exploit, hack, reverse-engineer, or interfere with the platform's functionality, security, or other users' experiences.</li>
                            <li><strong className="text-gray-300">Commercial use:</strong> Use the platform for unauthorized commercial purposes, including advertising products or services without our prior written permission.</li>
                            <li><strong className="text-gray-300">Illegal activity:</strong> Use the platform for any unlawful purpose or in violation of any applicable laws or regulations.</li>
                            <li><strong className="text-gray-300">Respect others:</strong> Treat all users with respect and courtesy. Toxic behavior, griefing encouragement, or deliberately ruining others' gaming experiences is not tolerated.</li>
                        </ul>
                        <p>
                        ...
                        <h2 className="text-xl font-semibold text-white">6. Avatar and Image Policy</h2>
                        ...
                        <h2 className="text-xl font-semibold text-white">7. Matchmaking Disclaimer</h2>
                        <p>
                        ...
                        {/* 8. LFG Groups */}
                        <h2 className="text-xl font-semibold text-white">8. Looking For Group (LFG)</h2>
                        <p>
                        ...
                        <h2 className="text-xl font-semibold text-white">9. Chat and Messaging</h2>
                        <p>
                        ...
                        <h2 className="text-xl font-semibold text-white">11. Third-Party Links and Services</h2>
                        <p>
                        ...
                        <h3 className="text-lg font-medium text-white">12.1 Termination by Us</h3>
                        <p>
                        ...
                        <h3 className="text-lg font-medium text-white">12.2 Termination by You</h3>
                        <p>
                        ...
                        {/* 14. Indemnification */}
                        <h2 className="text-xl font-semibold text-white">14. Indemnification</h2>
                        <p>
                        ...
                        <p>
                            ...
                            <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-gaming-purple hover:underline">
                        ...
                        {/* 17. Changes to Terms */}
                        <h2 className="text-xl font-semibold text-white">17. Changes to These Terms</h2>
                        <p>
